...
if($_POST){
    ...
    if(count($greska)==0){
        unset($_POST["sifra"]);
        $izraz=$veza->prepare("insert into klub (naziv_kluba, mjesto, naziv_stadiona, boja_dresa_domaca, boja_dresa_gost) 
							values (:naziv_kluba, :mjesto, :naziv_stadiona, :boja_dresa_domaca, :boja_dresa_gost);");
        $izraz->execute($_POST);
		    ...
		    <div class="form-group col-md-4">
		     ...
		     <div class="form-group col-md-4">
		     	<?php if(!isset($greska["naziv_stadiona"])): ?>
						  <label>Naziv stadiona
						    <input class="form-control"  type="text" id="naziv_stadiona" name="naziv_stadiona" placeholder="Maksimir"
		     ...
		     <div class="form-group col-md-4">
		     	<?php if(!isset($greska["boja_dresa_gost"])): ?>
						  <label>Boja dresa A
						    <input class="form-control"  type="text" id="boja_dresa_gost" name="grad" placeholder="Zagreb"
