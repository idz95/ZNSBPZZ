...
if($_POST){
	...
	if(count($greska)==0){
		unset($_POST["sifra"]);
		$izraz=$veza->prepare("insert into delegat (ime, prezime, email, lozinka, datum_rodjenja, mjesto, mobitel, liga) 
...
<html>
	...
	<div id="fh5co-work">
		...
		<h4 style="text-align: center;">Dodavanje delegata!</h4>
		  ...
		  <div class="form-row">
		    ...
		    <div class="form-group col-md-4">
		     ...
		     <div class="form-group col-md-4">
		      ...
		      <p><input type="submit" class="btn btn-primary btn-modify button expanded" value="Dodaj delegata"></input></p>
		</form>			
	</div>
