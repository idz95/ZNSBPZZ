	...
	<div id="fh5co-work">
			...
			<div class="row">
				...
				<div class="col-md-4 text-center animate-box">
												...
												?>
												<img style="max-width: 300px; max-height: 400px;" src="<?php echo $putanjaAPP; ?>images/delegati/<?php echo $_SESSION[$appID."autoriziran"]->sifra ?>.png">
												<?php else: ?>
					...
					<div class="list-group">
						...
						<a href="promijeniSlikuDelegat.php?sifra=<?php echo $_SESSION[$appID."autoriziran"]->sifra ?>" class="list-group-item">Promijeni sliku</a>
