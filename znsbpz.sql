...
insert into klub(sifra, naziv_kluba, mjesto, naziv_stadiona, boja_dresa_domaca, boja_dresa_gost, liga, broj_bodova) values
(null,'NK TOMISLAV','Donji Andrijevci', 'Andrijevci', 'Bijela', 'Žuta', 1, 0),
(null,'NK OMLADINAC','Gornja Vrba', 'Random', 'Plava', 'Žuta', 1, 0),
(null,'NK MLADOST','Sibinj', 'Sibinj', 'Plava', 'Žuta', 1, 0),
(null,'NK SVAČIĆ','Stari Slatnik', 'Stari Hrast', 'Plava', 'Žuta', 1, 0),
(null,'NK ZADRUGAR','Oprisavci', 'Oprisavci', 'Plava', 'Žuta', 1, 5),
(null,'NK MLADOST','Sibinj', 'Sibinj', 'Plava', 'Žuta', 1, 0),
(null,'NK SIKIREVCI','Sikirevci', 'Sikirevci', 'Plava', 'Žuta', 1, 0),
(null,'NK SLAVONAC','Bukovlje', 'Bukovlje', 'Plava', 'Žuta', 1, 0),
(null,'NK BATRINA','Batrina', 'Batrina', 'Plava', 'Žuta', 1, 0),
(null,'NK SLAVONAC','Nova Kapela', 'Nova Kapela', 'Plava', 'Žuta', 1, 0),
(null,'NK OMLADINAC','Vrbova', 'Vrbova', 'Plava', 'Žuta', 1, 0),
(null,'NK BUDUĆNOST','Rešetari', 'Rešetari', 'Plava', 'Žuta', 1, 0),
(null,'NK ZVONIMIR','Donja Vrba', 'Sibinj', 'Plava', 'Žuta', 1, 0),
(null,'NK OMLADINAC','Staro Topolje', 'Sibinj', 'Plava', 'Žuta', 1, 0),
(null,'NK SLAVEN','Prnjoni', 'Prnjoni', 'Plava', 'Žuta', 2, 0),
(null,'NK MLADOST','Cerenjani', 'Cerenjani', 'Plava', 'Žuta', 2, 0),
(null,'NK SLAVIJA','Panje', 'Sibinj', 'Plava', 'Žuta', 2, 0),
(null,'NK PSUNJ-SOKOL','Petrijvci', 'Sibinj', 'Plava', 'Žuta', 2, 0),
(null,'NK GRANIČAR','Motičina', 'Sibinj', 'Plava', 'Žuta', 2, 0),
(null,'NK SLAVONIJA','Puzdravci', 'Sibinj', 'Plava', 'Žuta', 2, 0),
(null,'NK SLAVONAC','Brkići', 'Sibinj', 'Plava', 'Žuta', 2, 0),
(null,'NK MLADOST','Cernik', 'Sibinj', 'Plava', 'Žuta', 2, 0),
(null,'NK POSAVAC','Kalić', 'Sibinj', 'Plava', 'Žuta', 2, 0),
(null,'NK DINAMO','Gromačnik', 'Sibinj', 'Plava', 'Žuta', 2, 0),
(null,'NK SLOBODA','Dilj', 'Sibinj', 'Plava', 'Žuta', 2, 0),
(null,'NK SLAVONAC','Gornja Bebrina', 'Sibinj', 'Plava', 'Žuta', 3, 0),
(null,'NK RAKETA','Beravci', 'Sibinj', 'Plava', 'Žuta', 3, 0),
(null,'NK GUNDINCI','Gundinci', 'Sibinj', 'Plava', 'Žuta', 3, 0),
(null,'NK SLOGA','Jaruge', 'Sibinj', 'Plava', 'Žuta', 3, 0),
(null,'NK DUBRAVA','Zadubravlje', 'Sibinj', 'Plava', 'Žuta', 3, 0),
(null,'NK POSAVINA','Velika Kopanica', 'Sibinj', 'Plava', 'Žuta', 3, 0),
(null,'NK GRANIČAR','Slav. Šamac', 'Sibinj', 'Plava', 'Žuta', 3, 0),
(null,'NK PERKOVCI','Stari Perkovci', 'Sibinj', 'Plava', 'Žuta', 3, 0),
(null,'NK DILJ','Klokočevik', 'Sibinj', 'Plava', 'Žuta', 3, 0),
(null,'NK SLAVONIJA','Prnjavor', 'Sibinj', 'Plava', 'Žuta', 3, 0),
(null,'NK GARDUN','Garčin', 'Sibinj', 'Plava', 'Žuta', 3, 0),
(null,'NK SLOGA','Vrpolje', 'Sibinj', 'Plava', 'Žuta', 3, 0),
(null,'NK MLADOST','Donja Bebrina', 'Sibinj', 'Plava', 'Žuta', 3, 0),
(null,'NK MLADOST','Čajkovci', 'Sibinj', 'Plava', 'Žuta', 3, 0),
(null,'NK BONK','Bebrina', 'Sibinj', 'Plava', 'Žuta', 4, 0),
(null,'NK SLOBODNICA','Slobodnica', 'Sibinj', 'Plava', 'Žuta', 4, 0),
(null,'NK BUDAINKA','Kolonija', 'Sibinj', 'Plava', 'Žuta', 4, 0),
(null,'NK SLAVONAC','Brodski Stupnik', 'Sibinj', 'Plava', 'Žuta', 4, 0),
(null,'NK TOMICA','Tomica', 'Sibinj', 'Plava', 'Žuta', 4, 0),
(null,'NK GRANIČAR','Klakar', 'Sibinj', 'Plava', 'Žuta', 4, 0),
(null,'NK PODCRKAVLJE','Podcrkavlje', 'Sibinj', 'Plava', 'Žuta', 4, 0),
(null,'NK SVJETLOST','Lužani', 'Sibinj', 'Plava', 'Žuta', 4, 0),
(null,'NK PODVINJE','Podvinje', 'Sibinj', 'Plava', 'Žuta', 4, 0),
(null,'NK ZDENAC','Brodski Zdenac', 'Sibinj', 'Plava', 'Žuta', 4, 0),
(null,'NK POSAVAC','Ruščica', 'Sibinj', 'Plava', 'Žuta', 4, 0),
(null,'NK MV-CROATIA 1976','SL. Brod', 'Sibinj', 'Plava', 'Žuta', 4, 0),
(null,'NK MLADOST','Malino', 'Pdaa', 'Plava', 'Žuta', 4, 0);
